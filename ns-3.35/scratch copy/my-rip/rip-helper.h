...
#ifndef MY_RIP_HELPER_H
#define MY_RIP_HELPER_H
 ...
 *
 */
class MyRipHelper : public Ipv4RoutingHelper
{
public:
  /*
   * Construct an MyRipHelper to make life easier while adding RIP
   * routing to nodes.
   */
  MyRipHelper ();

  /**
   * \brief Construct an MyRipHelper from another previously
   * initialized instance (Copy Constructor).
   * \param o The object to copy from.
   */
  MyRipHelper (const MyRipHelper &o);

  virtual ~MyRipHelper ();

  /**
   * \returns pointer to clone of this MyRipHelper
   *
...
private:
   ...
   */
  MyRipHelper &operator = (const MyRipHelper &o);
