...
#ifndef MY_IPV4_STATIC_ROUTING_HELPER_H
#define MY_IPV4_STATIC_ROUTING_HELPER_H
 ...
 */
class MyIpv4StaticRoutingHelper : public Ipv4RoutingHelper
{
public:
  /*
   * Construct an MyIpv4StaticRoutingHelper object, used to make configuration
   * of static routing easier.
   */
  MyIpv4StaticRoutingHelper ();

  /**
   * \brief Construct an MyIpv4StaticRoutingHelper from another previously 
   * initialized instance (Copy Constructor).
   * \param o object to be copied
   */
  MyIpv4StaticRoutingHelper (const MyIpv4StaticRoutingHelper &o);

  /**
   * \returns pointer to clone of this MyIpv4StaticRoutingHelper
   *
   ...
   */
  Ptr<MyIpv4StaticRouting> GetStaticRouting (Ptr<Ipv4> ipv4) const;
...
private:
   ...
   * \returns
   */
  MyIpv4StaticRoutingHelper &operator = (const MyIpv4StaticRoutingHelper &);
};
