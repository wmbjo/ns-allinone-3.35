...
#include "my-ipv4-static-routing.h"
...
NS_LOG_COMPONENT_DEFINE ("MyIpv4StaticRouting");

NS_OBJECT_ENSURE_REGISTERED (MyIpv4StaticRouting);

TypeId
MyIpv4StaticRouting::GetTypeId (void)
{
 static TypeId tid = TypeId ("ns3::MyIpv4StaticRouting")
   .SetParent<Ipv4RoutingProtocol> ()
   .SetGroupName ("Internet")
   .AddConstructor<MyIpv4StaticRouting> ()
 ;
 return tid;
}

MyIpv4StaticRouting::MyIpv4StaticRouting () 
 : m_ipv4 (0)
{
...
void 
MyIpv4StaticRouting::AddNetworkRouteTo (Ipv4Address network, 
...
void 
MyIpv4StaticRouting::AddHostRouteTo (Ipv4Address dest, 
                                  Ipv4Address nextHop,
                                  uint32_t interface,
                                  uint32_t metric)
{
...
void 
MyIpv4StaticRouting::SetDefaultRoute (Ipv4Address nextHop, 
                                   uint32_t interface,
                                   uint32_t metric)
{
...
void 
MyIpv4StaticRouting::AddMulticastRoute (Ipv4Address origin,
                                     Ipv4Address group,
...
void 
MyIpv4StaticRouting::SetDefaultMulticastRoute (uint32_t outputInterface)
{
...
uint32_t 
MyIpv4StaticRouting::GetNMulticastRoutes (void) const
{
 NS_LOG_FUNCTION (this);
...
MyIpv4StaticRouting::GetMulticastRoute (uint32_t index) const
{
 NS_LOG_FUNCTION (this << index);
 NS_ASSERT_MSG (index < m_multicastRoutes.size (),
                "MyIpv4StaticRouting::GetMulticastRoute ():  Index out of range");
...
bool
MyIpv4StaticRouting::RemoveMulticastRoute (Ipv4Address origin,
                                        Ipv4Address group,
                                        uint32_t inputInterface)
{
...
void 
MyIpv4StaticRouting::RemoveMulticastRoute (uint32_t index)
{
 NS_LOG_FUNCTION (this << index);
 uint32_t tmp = 0;
 for (MulticastRoutesI i = m_multicastRoutes.begin (); 
...
bool
MyIpv4StaticRouting::LookupRoute (const Ipv4RoutingTableEntry &route, uint32_t metric)
{
...
Ptr<Ipv4Route>
MyIpv4StaticRouting::LookupStatic (Ipv4Address dest, Ptr<NetDevice> oif)
{
...
MyIpv4StaticRouting::LookupStatic (
 Ipv4Address origin, 
 Ipv4Address group,
 uint32_t    interface)
{
...
uint32_t 
MyIpv4StaticRouting::GetNRoutes (void) const
{
 NS_LOG_FUNCTION (this);
...
MyIpv4StaticRouting::GetDefaultRoute ()
{
 NS_LOG_FUNCTION (this);
...
Ipv4RoutingTableEntry 
MyIpv4StaticRouting::GetRoute (uint32_t index) const
{
 NS_LOG_FUNCTION (this << index);
 uint32_t tmp = 0;
...
uint32_t
MyIpv4StaticRouting::GetMetric (uint32_t index) const
{
 NS_LOG_FUNCTION (this << index);
 uint32_t tmp = 0;
 for (NetworkRoutesCI j = m_networkRoutes.begin ();
...
void 
MyIpv4StaticRouting::RemoveRoute (uint32_t index)
{
 NS_LOG_FUNCTION (this << index);
 uint32_t tmp = 0;
...
Ptr<Ipv4Route> 
MyIpv4StaticRouting::RouteOutput (Ptr<Packet> p, const Ipv4Header &header, Ptr<NetDevice> oif, Socket::SocketErrno &sockerr)
{
...
bool 
MyIpv4StaticRouting::RouteInput  (Ptr<const Packet> p, const Ipv4Header &ipHeader, Ptr<const NetDevice> idev,
...
void
MyIpv4StaticRouting::DoDispose (void)
{
 NS_LOG_FUNCTION (this);
 for (NetworkRoutesI j = m_networkRoutes.begin (); 
      j != m_networkRoutes.end (); 
...
void 
MyIpv4StaticRouting::NotifyInterfaceUp (uint32_t i)
{
...
void 
MyIpv4StaticRouting::NotifyInterfaceDown (uint32_t i)
{
 NS_LOG_FUNCTION (this << i);
...
void 
MyIpv4StaticRouting::NotifyAddAddress (uint32_t interface, Ipv4InterfaceAddress address)
{
...
void 
MyIpv4StaticRouting::NotifyRemoveAddress (uint32_t interface, Ipv4InterfaceAddress address)
{
 NS_LOG_FUNCTION (this << interface << " " << address.GetLocal ());
 if (!m_ipv4->IsUp (interface))
   {
...
void 
MyIpv4StaticRouting::SetIpv4 (Ptr<Ipv4> ipv4)
{
...
void
MyIpv4StaticRouting::PrintRoutingTable (Ptr<OutputStreamWrapper> stream, Time::Unit unit) const
{
 ...
 *os << "Node: " << m_ipv4->GetObject<Node> ()->GetId ()
     ...
     << ", MyIpv4StaticRouting table" << std::endl;
