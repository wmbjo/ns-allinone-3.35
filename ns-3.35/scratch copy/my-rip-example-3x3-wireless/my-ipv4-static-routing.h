...
#ifndef MY_IPV4_STATIC_ROUTING_H
#define MY_IPV4_STATIC_ROUTING_H
 ...
 * protocol.
 * 
 * The MyIpv4StaticRouting class inherits from the abstract base class 
 * Ipv4RoutingProtocol that defines the interface methods that a routing 
 * protocol must support.
 *
 * \see MyIpv4RoutingProtocol
 * \see Ipv4ListRouting
 * \see Ipv4ListRouting::AddRoutingProtocol
 */
class MyIpv4StaticRouting : public Ipv4RoutingProtocol
{
public:
  /**
 ...
 *
 * \see Ipv4Address
 * \see MyIpv4StaticRouting::Lookup
 */
 ...
 *
 * \see Ipv4RoutingTableEntry
 * \see MyIpv4StaticRouting::RemoveRoute
 */
 ...
 *
 * \see Ipv4RoutingTableEntry
 * \see MyIpv4StaticRouting::GetRoute
 * \see MyIpv4StaticRouting::AddRoute
 */
 ...
 *
 * \see Ipv4MulticastRoutingTableEntry
 * \see MyIpv4StaticRouting::AddMulticastRoute
 */
...
#endif /* MY_IPV4_STATIC_ROUTING_H */
