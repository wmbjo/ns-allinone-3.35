...
{
  static TypeId tid = TypeId ("ns3::aodv2::TypeHeader")
    .SetParent<Header> ()
    .SetGroupName ("Aodv")
...
{
  static TypeId tid = TypeId ("ns3::aodv2::RreqHeader")
    .SetParent<Header> ()
    .SetGroupName ("Aodv")
...
{
      std::cout << "InsertPrecursor" << std::endl;
  static TypeId tid = TypeId ("ns3::aodv2::RrepHeader")
    .SetParent<Header> ()
    .SetGroupName ("Aodv")
...
{
  static TypeId tid = TypeId ("ns3::aodv2::RrepAckHeader")
    .SetParent<Header> ()
    .SetGroupName ("Aodv")
...
{
  static TypeId tid = TypeId ("ns3::aodv2::RerrHeader")
    .SetParent<Header> ()
    .SetGroupName ("Aodv")
