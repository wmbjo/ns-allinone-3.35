...
{
    std::cout << "InsertPrecursor Routing Table" << std::endl;
...
{
    std::cout << "LookupPrecursor Routing Table" << std::endl;
  NS_LOG_FUNCTION (this << id);
...
{
    std::cout << "DeletePrecursor Routing Table" << std::endl;
  NS_LOG_FUNCTION (this << id);
...
{
    std::cout << "DeleteAllPrecursors Routing Table" << std::endl;
...
{
    std::cout << "Create Routing Table" << std::endl;
...
{
    std::cout << "GetPrecursors Routing Table" << std::endl;
  NS_LOG_FUNCTION (this);
...
{
    std::cout << "LookupRoute Routing Table" << std::endl;
  NS_LOG_FUNCTION (this << id);
  Purge ();
...
{
    std::cout << "LookupValidRoute Routing Table" << std::endl;
  NS_LOG_FUNCTION (this << id);
...
{
    std::cout << "DeleteRoute Routing Table" << std::endl;
...
{
    std::cout << "AddRoute Routing Table" << std::endl;
  NS_LOG_FUNCTION (this);
  Purge ();
...
{
    std::cout << "SetEntryState  Routing Table" << std::endl;
  NS_LOG_FUNCTION (this);
  std::map<Ipv4Address, RoutingTableEntry>::iterator i =
    m_ipv4AddressEntry.find (id);
  if (i == m_ipv4AddressEntry.end ())
...
{
    std::cout << "GetListOfDestinationWithNextHop Routing Table" << std::endl;
  NS_LOG_FUNCTION (this);
  Purge ();
  unreachable.clear ();
...
{
    std::cout << "InvalidateRoutesWithDst Routing Table" << std::endl;
  NS_LOG_FUNCTION (this);
  Purge ();
...
{
    std::cout << "DeleteAllRoutesFromInterface Routing Table" << std::endl;
  NS_LOG_FUNCTION (this);
  if (m_ipv4AddressEntry.empty ())
    {
      return;
...
{
    std::cout << "MarkLinkAsUnidirectional Routing Table" << std::endl;
...
{
  std::cout << "Print Routing Table " << Simulator::Now().GetSeconds() << " Seconds"<< std::endl;
