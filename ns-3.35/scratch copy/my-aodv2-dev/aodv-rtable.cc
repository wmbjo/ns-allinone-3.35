...
NS_LOG_COMPONENT_DEFINE ("AodvRoutingTable2");
...
{
    std::cout << "InsertPrecursor" << std::endl;
...
{
    std::cout << "LookupPrecursor" << std::endl;
  NS_LOG_FUNCTION (this << id);
...
{
    std::cout << "DeletePrecursor" << std::endl;
  NS_LOG_FUNCTION (this << id);
...
{
    std::cout << "DeleteAllPrecursors" << std::endl;
...
{
    std::cout << "GetPrecursors" << std::endl;
  NS_LOG_FUNCTION (this);
...
{
    std::cout << "LookupValidRoute" << std::endl;
  NS_LOG_FUNCTION (this << id);
...
{
    std::cout << "SetEntryState" << std::endl;
  NS_LOG_FUNCTION (this);
  std::map<Ipv4Address, RoutingTableEntry>::iterator i =
    m_ipv4AddressEntry.find (id);
  if (i == m_ipv4AddressEntry.end ())
...
{
    std::cout << "GetListOfDestinationWithNextHop" << std::endl;
  NS_LOG_FUNCTION (this);
  Purge ();
  unreachable.clear ();
...
{
    std::cout << "InvalidateRoutesWithDst" << std::endl;
  NS_LOG_FUNCTION (this);
  Purge ();
...
{
    std::cout << "DeleteAllRoutesFromInterface" << std::endl;
  NS_LOG_FUNCTION (this);
  if (m_ipv4AddressEntry.empty ())
    {
      return;
...
{
    std::cout << "MarkLinkAsUnidirectional" << std::endl;
